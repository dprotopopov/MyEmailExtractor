...
namespace MyEmEx
{
    ...
    public class WebTask
    {
        ...
        public static void ThreadProc(object obj)
        {
            ...
            if (This != null)
            {
                HtmlDocument doc = MyEmExUtils.WebRequestHtmlDocument(This.Url, This.Method);
                try
                {
                    Arguments arguments = MyEmExUtils.BuildArguments(This.Url, This.Method);
                    This.ReturnFields = MyEmExUtils.BuildReturnFields(doc.DocumentNode, arguments, This.ReturnFieldInfos);
